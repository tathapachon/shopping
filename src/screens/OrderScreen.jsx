...
const OrderScreen = () =>{
    ...
    return(
        ...
        <div className="container">
            <div className="row order-detail">
                <div className="col-lg-4 col-sm-4 mb-5 mb-sm-0">
                    <div className="row">
            ...
            <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-5 mb-sm-0" >
                <div className="row">
                    <div className="col-md-4 center">
                        <div className="alert-success order-box">
        ...
        <div className="row">
            <div className="col-md-4 center">
                ...
                <div className="dg-danger p-1 col-12">
                    <p className="text-white text-center text-sm-start">
                        Not Delivered
                    </p>
                </div>
 ...
 <div className="row order-product justify-content-between">
